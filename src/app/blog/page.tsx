      ...
      <PublicPageShell>
        ...
        <SectionBlock title="Featured post.">
          <Link
            ...
            className="group grid overflow-hidden rounded-[1.4rem] border border-[var(--glass-border)] bg-[color-mix(in_srgb,var(--surface)_38%,transparent)] shadow-[0_24px_80px_color-mix(in_srgb,var(--bg-deep)_24%,transparent)] backdrop-blur-2xl lg:grid-cols-[1.05fr_0.95fr]"
          >
            ...
            <div className="p-6 sm:p-8 lg:p-10">
              ...
              <h2 className="title-serif my-8 text-[clamp(1.95rem,4vw,3rem)] font-normal leading-[1] tracking-tight text-[var(--on-surface)]">
                {featured.title}
              </h2>
