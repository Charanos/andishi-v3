...
function SectionTitle({
  ...
  return (
    <h2
      className={`title-serif text-[clamp(2.18rem,4.5vw,3.45rem)] font-normal leading-[0.98] tracking-tight text-[var(--on-surface)] ${className}`}
    >
      {children}
    </h2>
  );
...
function RouteBar() {
  return (
    <div className="sticky top-20 z-30 hidden px-5 sm:px-8 lg:block lg:px-10">
  ...
  return (
    <>
      <main className="relative isolate overflow-hidden bg-[var(--bg)]">
        ...
        <section className="relative z-[1] overflow-hidden px-5 pb-16 pt-32 sm:px-8 lg:px-10 lg:pb-24 lg:pt-40">
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-0 z-0 opacity-[0.08]"
            style={patternTextureStyle}
          ...
          />
          <div className="relative z-[5] mx-auto grid max-w-[92rem] gap-10 lg:grid-cols-[minmax(0,0.92fr)_minmax(26rem,0.86fr)] lg:items-center">
            <div className="relative z-[1]">
              <SectionEyebrow>How hiring works</SectionEyebrow>
              <h1 className="title-serif max-w-[18ch] text-[clamp(3.15rem,7.2vw,5.35rem)] font-normal leading-[0.92] tracking-tight text-[var(--on-surface)]">
        ...
        >
          <div
            ...
            style={patternTextureStyle}
          />
          <div className="relative z-[1] mx-auto grid max-w-[92rem] gap-10 lg:grid-cols-[0.34fr_1fr] lg:items-start">
        ...
        >
          ...
          <div className="relative z-[1] mx-auto max-w-[92rem]">
            <div className="mb-12 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              <SectionTitle className="max-w-[19ch]">
        ...
        >
          <div
            ...
            style={patternTextureStyle}
          />
          <div className="relative z-[1] mx-auto grid max-w-[92rem] gap-10 lg:grid-cols-[0.42fr_1fr] lg:items-start">
          ...
          <div className="mx-auto max-w-[66rem]">
            <div className="relative grid min-h-[34rem] place-items-center overflow-hidden rounded-[1.5rem] border border-[var(--glass-border)] bg-[color-mix(in_srgb,var(--surface)_40%,transparent)] px-6 py-16 text-center shadow-[0_28px_90px_color-mix(in_srgb,var(--bg-deep)_26%,transparent)] backdrop-blur-2xl sm:px-10 lg:min-h-[38rem] lg:px-20 lg:py-24">
              ...
              <div className="relative z-[1] mx-auto max-w-2xl">
                ...
                <h2 className="title-serif mx-auto mt-4 max-w-[92rem] text-[clamp(2.35rem,4.8vw,3.8rem)] font-normal leading-[0.98] tracking-tight text-[var(--on-surface)]">
