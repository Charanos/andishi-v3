...
import { DrawerPanel } from "@/components/dashboard/shared/drawer-panel";
import { EarningsCard } from "@/components/dashboard/shared/earnings-card";
import { EmptyState } from "@/components/dashboard/shared/empty-state";
import { FilterBar } from "@/components/dashboard/shared/filter-bar";
import { InsightsCard } from "@/components/dashboard/shared/insights-card";
import { KanbanBoard } from "@/components/dashboard/shared/kanban-board";
import { OnboardingChecklist } from "@/components/dashboard/shared/onboarding-checklist";
import { ProfileCard } from "@/components/dashboard/shared/profile-card";
import { ProjectCard } from "@/components/dashboard/shared/project-card";
import { TimeTracker } from "@/components/dashboard/shared/time-tracker";
import { WelcomeModal } from "@/components/dashboard/shared/welcome-modal";
  ...
  return (
    <div className="grid gap-6">
      <header className="max-w-3xl">
        ...
        <h1 className="title-serif mt-4 text-[clamp(2.42rem,5vw,3.9rem)] font-normal leading-[0.96] tracking-tight text-[var(--on-surface)]">
          {title}
        </h1>
