  ...
  return (
    <div className="fixed inset-0 z-[80] grid place-items-center bg-[color-mix(in_srgb,var(--bg-deep)_78%,transparent)] p-5 backdrop-blur-xl">
      <div className="relative w-full max-w-xl rounded-[1.5rem] border border-[var(--glass-border)] bg-[var(--surface)] p-6 shadow-[0_28px_90px_color-mix(in_srgb,var(--bg-deep)_38%,transparent)]">
        ...
        <h2 className="title-serif mt-4 text-[clamp(2.3rem,4.6vw,3.2rem)] font-normal leading-[1] tracking-tight text-[var(--on-surface)]">
          {roleLabels[role]}
        </h2>
        <p className="body-md my-8 text-[var(--on-surface-dim)]">
          This workspace is ready for the next activation step. Review the
          checklist, open the highest-signal page, and keep the handoff moving.
        </p>
        <button
          type="button"
          onClick={() => setOpen(false)}
