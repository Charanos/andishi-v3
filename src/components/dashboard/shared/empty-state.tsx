...
export function EmptyState({
  ...
  return (
    <div className="rounded-[1.25rem] border border-dashed border-[color-mix(in_srgb,var(--on-surface)_18%,transparent)] bg-[var(--glass-bg)] p-8 text-center backdrop-blur-2xl">
      ...
      <h2 className="title-serif my-8 text-[1.4rem] font-medium leading-tight text-[var(--on-surface)]">
        {heading}
      </h2>
      <p className="body-md mx-auto mt-3 max-w-md text-[var(--on-surface-dim)]">
        {body}
      </p>
      {cta && (
        <Link
