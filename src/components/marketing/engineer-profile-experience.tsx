  ...
  return (
    <main className="relative isolate overflow-visible bg-[var(--bg)]">
      <CustomCursorRegion className="relative isolate px-5 sm:px-8 lg:px-10">
        ...
        <div className="relative z-[1] mx-auto w-full max-w-[92rem] pb-24 pt-32 lg:pt-36">
          <motion.div
            ...
            <div className="relative min-h-[28rem] overflow-hidden lg:min-h-[32rem]">
              ...
              <div className="relative z-[1] flex min-h-[28rem] max-w-4xl flex-col justify-end px-5 pb-8 pt-24 sm:px-8 lg:min-h-[32rem] lg:px-10 lg:pb-10">
                ...
                <motion.h1
                  ...
                  className="title-serif max-w-[18ch] text-[clamp(3.15rem,7.4vw,5.25rem)] font-normal leading-[0.94] tracking-tight text-[var(--on-surface)]"
                >
                  {engineer.name}
                </motion.h1>
                ...
                <motion.p
                  ...
                  className="body-md my-8 max-w-2xl text-[var(--on-surface-dim)]"
                >
            ...
            <aside className="grid gap-5 self-start xl:sticky xl:top-28">
              <FadeIn>
                <ProfilePanel>
                  ...
                  <div className="my-8 grid grid-cols-3 overflow-hidden rounded-2xl border border-[var(--glass-border)] bg-[color-mix(in_srgb,var(--surface)_34%,transparent)]">
                    {stats.map((stat) => (
                      <div
                        key={stat.label}
