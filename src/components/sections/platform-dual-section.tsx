...
export function PlatformDualSection() {
  ...
  return (
    <section
      className="relative isolate overflow-hidden bg-[color-mix(in_srgb,var(--bg-deep)_58%,var(--bg))] px-5 py-24 sm:px-8 lg:px-10 lg:py-32"
      aria-labelledby="platform-heading"
    >
      <CustomCursorRegion className="-mx-5 -my-24 px-5 py-24 sm:-mx-8 sm:px-8 lg:-mx-10 lg:-my-32 lg:px-10 lg:py-32">
        <div
          aria-hidden="true"
        ...
        <div className="relative z-[1] mx-auto max-w-[92rem]">
          <div className="mb-12 grid gap-8 lg:mb-16 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              ...
              <h2
                id="platform-heading"
                className="title-serif max-w-[19ch] text-[clamp(2.7rem,5.4vw,4.45rem)] font-normal leading-[0.94] tracking-tight text-[var(--on-surface)]"
              >
