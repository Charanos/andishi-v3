...
export function FAQSection() {
  ...
  return (
    <section id="faq" className="w-full px-5 py-20 sm:px-8 lg:px-10 lg:py-32">
              ...
              return (
                <GlassCard
                  ...
                  className={cn(
                    "p-0",
                    active &&
                      "border-[color-mix(in_srgb,var(--primary)_24%,transparent)]",
                  )}
                >
                  <button
                    type="button"
                  ...
                  <AnimatePresence initial={false}>
                    {active ? (
                      ...
                      >
                        <p className="body-md px-5 pb-5 text-[var(--on-surface-dim)] sm:px-6">
                          {item.a}
                        </p>
                      </motion.div>
                    ) : null}
