...
> Component patterns from Andishi's current Component_Library + THEME_GUIDE are
> adopted selectively for fonts, animation springs, tooltip patterns, glass card structure, and dashboard shell behavior.
...
>
> **Dashboard execution, May 2026:** `docs/DASHBOARD_MASTER_IMPLEMENTATION.md`
> supersedes dashboard guidance in this older complete spec. Use it for auth,
> RBAC, dashboard shell, component, route, integration, and QA sequencing.
...
> stat values, currency, IDs, and table data, directly mirroring the current Andishi dashboard pattern.
